...
echo "  3. Run: brew install whisper-cpp"
echo "  4. Run: ~/.config/open-wispr/open-wispr download-model base.en"
echo "  5. Grant Accessibility + Microphone permissions"
echo "  6. (Optional) Install launch agent for auto-start:"
echo "     bash scripts/portable-install.sh  # just the config+agent parts"
